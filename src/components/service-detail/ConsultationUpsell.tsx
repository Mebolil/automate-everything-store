      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-display text-2xl md:text-3xl font-bold tracking-tight">
            Teknik İşlerle Uğraşmak İstemiyor Musunuz?
          </h2>
          <p className="mt-4 text-background/70 leading-relaxed max-w-xl mx-auto">
            Bu sistemi sizin altyapınıza bizzat entegre edelim, ekibinize eğitim verelim
            ve 3 ay boyunca ücretsiz bakımını üstlenelim.
          </p>
          <Button
            size="lg"
            className="mt-8 text-base px-8 gap-2 bg-primary text-primary-foreground hover:bg-primary/90"
          >
            Projeyi Birlikte Yürütelim (Teklif Al)
          </Button>
        </motion.div>
      </div>
    </section>
